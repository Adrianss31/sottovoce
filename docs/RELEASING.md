...
4. Crea una release in bozza con un tag corrispondente alla versione, per esempio `v0.1.2`, sul commit effettivamente verificato. Allega l’APK firmato, `update.json` e `SHA256SUMS`.
